...
checkButton.addEventListener("click",(e)=>{
    ...
    if (currentPriceNum > purchasePriceNum){
        ...
        outputDiv.innerHTML=`<div class="result-div" style="width:100%"><h1>Your Profit is ${profitPercent}% and it is rupees ${profit}</h1></div>`;
        ...
        outputDiv.innerHTML=`<div class="result-div" style="width:100%"><h1>Ohh you have a Loss of ${lossPercentage}% and it is rupees ${loss}</h1></div>`;
       

        if(lossPercentage>50){
            document.body.style.backgroundColor="#092409";
        }
    }
})